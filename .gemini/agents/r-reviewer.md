...
2. **Read `.gemini/rules/r-code-conventions.md`** for the current standards
...
- [ ] Check `.gemini/rules/r-code-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `.gemini/rules/r-code-conventions.md` for project-specific bugs.
