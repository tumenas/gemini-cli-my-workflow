...
- `.gemini/agents/editor.md` — reads this file.
- `.gemini/agents/domain-referee.md` — applies domain-referee adjustments.
- `.gemini/agents/methods-referee.md` — applies methods-referee adjustments.
- `.gemini/skills/review-paper/SKILL.md` — `--peer [journal]` mode entry point.
