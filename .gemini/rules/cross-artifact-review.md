...
- `.gemini/skills/review-paper/SKILL.md` — the orchestrator.
- `.gemini/skills/review-r/SKILL.md` — code reviewer.
- `.gemini/skills/audit-reproducibility/SKILL.md` — numeric claims verifier.
- `.gemini/rules/replication-protocol.md` — tolerance contract.
