---
paths:
  - ".gemini/skills/lit-review/SKILL.md"
  - ".gemini/skills/research-ideation/SKILL.md"
  - ".gemini/skills/respond-to-referees/SKILL.md"
  - ".gemini/skills/review-paper/SKILL.md"
...
Symmetric partner to **Pre-Flight Reports** (`.gemini/rules/content-invariants.md` + skill-level `## Phase 0`). Where Pre-Flight proves inputs were read *before* work, Post-Flight proves the output's factual claims hold *after* drafting — before the skill returns to the user.
...
- **Definitions Gemini introduces itself** ("let τ denote the treatment effect")
...
- `.gemini/agents/claim-verifier.md` — the forked verifier.
- `.gemini/skills/verify-claims/SKILL.md` — user-facing wrapper for ad-hoc verification of any text.
- `.gemini/rules/content-invariants.md` — Pre-Flight (input side).
- `.gemini/rules/cross-artifact-review.md` — pattern-based; Post-Flight is draft-based.
- `.gemini/rules/summary-parity.md` — rule against enumerative summaries drifting from their bodies; Post-Flight is the factual equivalent for draft content.
