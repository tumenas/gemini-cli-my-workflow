...
| "Edits to `.gemini/agents/X.md` and `.gemini/skills/Y/SKILL.md`" | "Existing infrastructure revised" |
...
- `.gemini/skills/commit/SKILL.md` — when writing the commit message for a doc-heavy PR, apply this rule to the `## Summary` section before pushing.
