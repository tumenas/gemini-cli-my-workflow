...
Compare numeric claims in a manuscript (point estimates, standard errors, p-values, counts) against the actual outputs produced by the analysis pipeline. Report PASS / FAIL per claim against the tolerance thresholds defined in [`.gemini/rules/replication-protocol.md`](../../rules/replication-protocol.md).
...
1. read_file [`replication-protocol.md`](../../rules/replication-protocol.md) for the tolerance thresholds currently in effect.
...
write_file the extracted claims to `quality_reports/reproducibility_claims_[manuscript-name].json` so the user can review the extraction before audit.
...
write_file `quality_reports/reproducibility_audit_[manuscript-name].md`:
...
**Tolerance source:** .gemini/rules/replication-protocol.md
...
- [`.gemini/rules/replication-protocol.md`](../../rules/replication-protocol.md) — the tolerance contract.
- [`.gemini/skills/review-r/SKILL.md`](../review-r/SKILL.md) — catches code-style issues; this skill catches NUMERICAL reproducibility.
- [`.gemini/skills/review-paper/SKILL.md`](../review-paper/SKILL.md) — content review; pair with this skill for a full pre-submission audit.
