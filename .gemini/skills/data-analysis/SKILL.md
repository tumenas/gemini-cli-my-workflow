...
- **Follow R code conventions** in `.gemini/rules/r-code-conventions.md`
...
- **Use project theme** for all figures (check for custom theme in `.gemini/rules/`)
...
- `.gemini/rules/r-code-conventions.md` — [one-line summary of most relevant rule]
- `.gemini/rules/content-invariants.md` — [INV-9, INV-10, INV-11, INV-12 applicable]

**codebase_investigator interpretation:** [one sentence restating what the user asked for]
