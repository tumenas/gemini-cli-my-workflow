...
In a single message, spawn 7 codebase_investigator tool calls (one per lens). Each subagent gets:
...
- `.gemini/skills/review-paper/SKILL.md` — the single-pass and `--adversarial` modes (cheaper, faster).
- `.gemini/skills/validate-bib/SKILL.md` — invoked by Lens 7.
- `.gemini/skills/audit-reproducibility/SKILL.md` — complementary; numeric-claims side of the audit.
