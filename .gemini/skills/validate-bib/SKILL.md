...
1. **read_file the bibliography file** and extract all citation keys.
...
5. **write_file report** to `quality_reports/bib_audit_structural.md`.
...
`Bibliography_base.bib` at repo root by default; override via GEMINI.md.
...
- `.gemini/skills/review-paper/SKILL.md` — pair for full pre-submission.
- `.gemini/skills/audit-reproducibility/SKILL.md` — numeric-claims counterpart.
