...
Fact-check a draft using the **Post-Flight Verification protocol** ([`.gemini/rules/post-flight-verification.md`](../../rules/post-flight-verification.md)).
...
- `claim-verifier` agent file exists at `.gemini/agents/claim-verifier.md`

If any fail → surface the failure, do NOT proceed.

### Phase 1 — Extract claims

read_file the draft. Identify factual assertions of these types:
...
```
codebase_investigator: subagent_type=claim-verifier, context=fork
...
- [`.gemini/agents/claim-verifier.md`](../../agents/claim-verifier.md) — the forked verifier.
- [`.gemini/rules/post-flight-verification.md`](../../rules/post-flight-verification.md) — the protocol.
