# GEMINI.MD -- Academic Project Development with Gemini CLI

<!-- HOW TO USE: Replace [BRACKETED PLACEHOLDERS] with your project info.
     Customize Beamer environments and CSS classes for your theme.
     Keep this file under ~150 lines — Gemini loads it every session.
...
[YOUR-PROJECT]/
├── GEMINI.MD                    # This file
├── .gemini/                     # Rules, skills, agents, hooks
...
# Surface-count sync (README ↔ GEMINI.md ↔ guide ↔ landing page)
